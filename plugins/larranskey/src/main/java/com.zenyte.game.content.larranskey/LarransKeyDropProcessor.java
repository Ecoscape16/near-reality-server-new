...
public class LarransKeyDropProcessor extends DropProcessor {
    ...
    static {
        RANK_DROP_BOOST.put(MemberRank.Emerald, 10F);
        RANK_DROP_BOOST.put(MemberRank.Pyrite, 15F);
        RANK_DROP_BOOST.put(MemberRank.Diamond, 20F);
        RANK_DROP_BOOST.put(MemberRank.Ruby, 25F);
        RANK_DROP_BOOST.put(MemberRank.Sapphire, 30F);
        RANK_DROP_BOOST.put(MemberRank.Onyx, 40F);
    }
