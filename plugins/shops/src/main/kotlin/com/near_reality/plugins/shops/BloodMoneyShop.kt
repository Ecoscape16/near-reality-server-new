...
class BloodMoneyShop : ShopScript() {
    init {
        "Blood money Store"(290, ShopCurrency.BLOOD_MONEY, STOCK_ONLY) {
            VIGGORAS_CHAINMACE(100, 0, 15000, ironmanRestricted = true)
            CRAWS_BOW(100, 0, 15000, ironmanRestricted = true)
            THAMMARONS_SCEPTRE(100, 0, 15000, ironmanRestricted = true)
