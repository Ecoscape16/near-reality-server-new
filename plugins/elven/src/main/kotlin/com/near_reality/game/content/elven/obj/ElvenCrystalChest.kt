...
class ElvenCrystalChest : ObjectAction {
    ...
    private fun getChance(player: Player): Int {
        ...
        return when {
            rank.equalToOrGreaterThan(MemberRank.Amethyst) -> 3
            rank.equalToOrGreaterThan(MemberRank.Onyx) -> 3
            rank.equalToOrGreaterThan(MemberRank.Sapphire) ->  4
            rank.equalToOrGreaterThan(MemberRank.Ruby) -> 6
            rank.equalToOrGreaterThan(MemberRank.Diamond) ->  6
            rank.equalToOrGreaterThan(MemberRank.Pyrite) -> 9
            else -> return 9
        }
    }
