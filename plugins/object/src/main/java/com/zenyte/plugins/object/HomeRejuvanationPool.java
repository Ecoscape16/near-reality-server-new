...
public class HomeRejuvanationPool implements ObjectAction {
    ...
    private int getUsageCooldownDurationInSeconds(final Player player) {
        ...
        if (memberRank.equalToOrGreaterThan(MemberRank.Amethyst)) {
            return 0;
        } else if (memberRank.equalToOrGreaterThan(MemberRank.Onyx)) {
            return 0;
            ...
            return 60;
        } else if (memberRank.equalToOrGreaterThan(MemberRank.Pyrite)) {
            return 90;
