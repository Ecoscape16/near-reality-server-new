...
object WildernessKillStreakModule {
    ...
    private fun getRankBoost(rank: MemberRank?): Int {
        return when (rank) {
            MemberRank.Emerald -> 5
            MemberRank.Pyrite -> 10
            MemberRank.Diamond -> 15
            MemberRank.Ruby -> 20
            MemberRank.Sapphire -> 30
            MemberRank.Onyx -> 40
            MemberRank.Amethyst -> 50
            else -> 0
        }
    }
}
...
//    listOf(MemberRank.NONE, MemberRank.Emerald, MemberRank.Amethyst).forEach { privilege ->
//        // 0..50
...
//
////    printAsciiTable(listOf(bloodMoneyReward(MemberRank.Amethyst, 10, 50, 10)))
//}
//
