        ...
        if (!acceptDPinConfirmation && player.askDonatorPinPrompt && storeOrders.any { Bond[it.product.itemId] != null }){
            player.dialogue {
                ...
                options("Are you sure you want to continue?") {
                    ...
                    "How does this work?" {
                        player.dialogue {
                            val rank = "${Crown.Emerald.crownTag}<col=${MemberRank.Emerald.yellColor}>Premium</col>"
                            ...
                            plain("For example the $rank rank requires a total spent of ${ApiMemberRank.Emerald.requiredDonatedAmount} to maintain it." +
                                    "<br>So if you have ${ApiMemberRank.Emerald.requiredDonatedAmount} dollar total spent, and you buy a 10$ D-Pin," +
                                    "<br>your total spent will be ${ApiMemberRank.Emerald.requiredDonatedAmount-10} dollars, and you will lose your Premium rank.").executeAction {
