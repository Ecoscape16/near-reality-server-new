...
import static com.zenyte.game.world.entity.player.privilege.MemberRank.Emerald;
...
public class AnvilObject implements ObjectAction {
    ...
    public void handleObjectAction(final Player player, final WorldObject object, final String name, final int optionId, final String option) {
        ...
        if (player.getMemberRank().equalToOrGreaterThan(Emerald) && object.getLocation().equals(3358, 8156, 2)) {
            skipLevelCheck = true;
        }
