            ...
            public void handle(final Player player, final NPC npc) {
                player.getDialogueManager().start(new Dialogue(player, npc) {
                    ...
                    public void buildDialogue() {
                        ...
                        final boolean canInsureForFree = player.getMemberRank().equalToOrGreaterThan(MemberRank.Pyrite) && player.getPetInsurance().getInsuredPets().size() >= 2;
                        if (canInsureForFree) {
