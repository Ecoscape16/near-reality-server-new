...
public enum DonatorZoneTeleports {
    ...
    UDI(MemberRank.Amethyst, create(new Location(3393, 7758, 0))),
    LDI(MemberRank.Sapphire, create(new Location(3390, 7575, 0))),
    RDI(MemberRank.Ruby, create(new Location(3404, 8003, 0))),
    DI(MemberRank.Emerald, create(new Location(3359, 8170, 2))),
    DIE(MemberRank.Pyrite, create(new Location(3359, 8299, 2)));
