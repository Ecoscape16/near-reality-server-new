...
public class Player extends AbstractEntity implements UsernameProvider {
     ...
     * @param godMode true to enable god mode; false to disable.
     */
    ...
    public void processHit(final Hit hit) {
        ...
        if (isGodMode()) {
            // Option 1: Simply cancel this hit by setting its damage to 0.
            hit.setDamage(0);
            return;
            }
...
//            System.out.println("player.processTempState("+getUsername()+", "+fakeInventoryState+") -> "+pair);
    ...
    public void setMemberRank(final MemberRank rank, boolean autoLoad) {
        ...
        varManager.sendBit(16000, memberRank.equalToOrGreaterThan(MemberRank.Emerald) ? 1 : 0);
        getUpdateFlags().flag(UpdateFlag.APPEARANCE);
    }
...
//    }
    ...
    public MemberRank getMemberRank() {
        if (getBooleanAttribute("amethyst_donator")) {
            return MemberRank.Amethyst;
        }
        return memberRank;
    }
