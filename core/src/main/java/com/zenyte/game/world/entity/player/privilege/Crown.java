...
public enum Crown {
    ...
    Emerald(14, CrownType.MEMBER),
    Pyrite(15, CrownType.MEMBER),
    Diamond(16, CrownType.MEMBER),
    Ruby(17, CrownType.MEMBER),
    Sapphire(18, CrownType.MEMBER),
    Onyx(19, CrownType.MEMBER),
    Amethyst(20, CrownType.MEMBER),
