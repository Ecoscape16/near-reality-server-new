...
enum class ApiMemberRank(val formattedName: String, val requiredDonatedAmount: Int) {
    NONE("None", 0),
    Emerald("Emerald", 25),
    Pyrite("Pyrite Premium", 50),
    Diamond("Diamond Premium", 200),
    Ruby("Ruby Premium", 400),
    Sapphire("Sapphire Premium", 1000),
    Onyx("Onyx Premium", 2500),
    Amethyst("Amethyst Premium", 5000),
